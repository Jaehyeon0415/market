...
class HomeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        // sample data
        cardList.add(Card(getString(R.string.title01), "디지털/가전", getString(R.string.writer01), getString(R.string.price01), R.drawable.airpod, "실사용 3개월, 상태 A급입니다."))
        cardList.add(Card(getString(R.string.title02), "디지털/가전", getString(R.string.writer02), getString(R.string.price02), R.drawable.applepencil, "실사용 4개월, 상태 A급입니다."))
        ...
        cardList.add(Card(getString(R.string.title09), "디지털/가전", getString(R.string.writer09), getString(R.string.price09), R.drawable.imac, "실사용 3개월, 상태 A급입니다."))
        ...
        cardList.add(Card(getString(R.string.title11), "디지털/가전", "이재환", "150000", R.drawable.tv, "실사용 3개월, 상태 A급입니다."))
