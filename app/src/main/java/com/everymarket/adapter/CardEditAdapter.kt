...
class CardEditAdapter(val context: Context, private val cardList: ArrayList<Card>):
    ...
    private val myRef = database.reference.child("users").child(uid).child("myCard")
    private val mRef = database.reference
    private val userRef = mRef.child("users")
...
//                val image = stream.toByteArray()
            ...
            // 해당하는 Item 삭제
            itemView.sellDeleteButton.setOnClickListener {
